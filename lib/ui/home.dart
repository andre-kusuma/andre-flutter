...
class _HomeState extends State<Home> {
  ...
  Future<List> getData() async{
    final response= await http.get("http://192.168.43.58/apijamtangan/index.php/penjualan");
  ...
  Widget build(BuildContext context){
    return new Scaffold(
      appBar: new AppBar(
        title: new Text("PENJUALAN JAM TANGAN"),
      ),
          ...
          child: new GestureDetector(
            ...
            child: new Card(
              child: new ListTile(
                ...
                subtitle: new Text("Jam Tangan : ${list[i]['keterangan']}"),
