// import 'package:penjualan_jamtangan/main.dart';
...
class _DetailState extends State<Detail> {
          ...
          child: new Center(
            child: new Column(
              children: <Widget>[
                ...
                new Text("Jam Tangan : ${widget.list[widget.index]['keterangan']}", style: new TextStyle(fontSize: 18.0),),
  ...
  Future<http.Response> deletePenjualan(id) async {
    final http.Response response= await http.delete("http://192.168.43.58/apijamtangan/index.php/penjualan/delete/$id");
